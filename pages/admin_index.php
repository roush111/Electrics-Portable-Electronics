...
<head>
    ...
    <title>Electrics - Portable Electronics</title>
...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Roushan Prasad" data-placement="bottom" target="">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter">
            <div class="page-header-image" data-parallax="true" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSau_AuUTLPLcsHoHiar7mB3rUZjDhRN7fdcw&usqp=CAU');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="../assets/img/ecom3.png" alt="circle Image" width="300px" class="rounded-circle">
                        <br><br>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Electrics-Portable Electronics</h2>
                    ...
                    ?>   
                        <div class="row-sm-3">
                            ...
                            <div class="caption">
                              ...
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Rupees <?php echo $res['prod_price']; ?></medium></h6>
                            </div>
