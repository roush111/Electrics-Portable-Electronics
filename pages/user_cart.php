...
<body class="index-page sidebar-collapse">
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons shopping_basket"></i> &nbsp Shop More</a>
                      <hr color="orange"> 
  ...
  <form method="post" action="user_payment.php">
    ...
    <h5>[ <small><?php echo $count2;?> </small>] Items</h5>  
