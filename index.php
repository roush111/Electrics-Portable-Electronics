...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../website/Electicks Website/page/home.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Roushan Prasad" data-placement="bottom" target="">
    ...
    <div class="wrapper">
        <div class="page-header" filter-color="white">
            <div class="page-header-image" data-parallax="true" style="background-image: url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.123rf.com%2Fphoto_115504201_flat-lay-composition-with-headphones-smartphone-laptop-and-space-for-text-on-color-background.html&psig=AOvVaw1jCO0-Rn7z3akTowJaIeLa&ust=1649355157170000&source=images&cd=vfe&ved=0CAoQjRxqFwoTCMjBg_SEgPcCFQAAAAAdAAAAABAJ');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="./assets/img/ecom.jpg" alt="square Image" class="circle">
                        <br><br>
...
?>   
    <div class="row-sm-3">
        <div class="thumbnail">
            ...
            <img src="uploads/<?php echo $res['prod_pic1']; ?>"height="300px">
            <?php else: ?>
            <img src="uploads/default.png"height="300px">
            <?php endif; ?>
        <div class="caption">
          <h5><b><?php echo $res['prod_name'];?></b></h5>
          <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">rupees <?php echo $res['prod_price']; ?></medium></h6>
        </div>
